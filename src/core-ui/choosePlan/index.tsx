...
const SelectableContainer: React.FC<SelectableContainerProps> = ({
  ...
  const containerClasses = `
    relative rounded-md cursor-pointer transition-colors duration-300 
  ...
  return (
    <div onClick={handleClick} className={containerClasses}>
      ...
      {outline && isSelected && (
        <div className="absolute top-0 right-0 mt-2 mr-2 text-green-500">
          <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle cx="15" cy="15" r="8" fill="#131135" />
            <path
